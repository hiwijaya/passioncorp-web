      ...
      <div className="flex flex-col w-full  max-w-7xl mx-4">
        ...
        <div className={`${menuVisible ? 'block' : 'hidden'} text-white py-5`}>
          <nav className="flex flex-col items-center w-full text-white gap-5 mb-5">
            ...
            <a href="/news">News</a>
            <a href="/faq">FAQ</a>
            <a href={`/kontakWA?redirect=${encodeURIComponent('https://wa.me/6282311000310?text=Hi%2C%20Passion%20Corp%20Indonesia%2C%20I%20know%20you%20from%20website%20https%3A%2F%2Fpassioncorp.id%2F')}`} target="_blank" className="rounded-xl bg-sky-500 text-white px-10 py-3">Hire Us</a>
          </nav>
        </div>
