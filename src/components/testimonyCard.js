...
const TestimonyCard = ({words, name, title}) => (
  <div className="relative bg-white w-[250px] sm:w-[300px]  h-[370px] p-4 sm:p-5 rounded-xl shrink-0">
    <StaticImage className="absolute bottom-0 right-0 z-0 w-2/3" src="../images/background-testimony.png" alt="testimony background" />
    <div className="flex flex-col justify-between text-sm text-gray-500 shrink-0 z-10">
