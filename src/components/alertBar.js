...
const AlertBar = () => {
  return(
    <div className="flex flex-col md:flex-row space-y-2 md:space-x-2 items-center justify-center bg-gray-900 text-white p-4 w-full">
      ...
      <a href={`/kontakWA?redirect=${encodeURIComponent('https://wa.me/6289609399684?text=Hi%2C%20Passion%20Corp%20Indonesia%2C%20i%20need%20more%20information%20about%20%E2%80%9Cget%20cashback%E2%80%9D')}`} target="_blank" rel="noreferrer"
